...
<head>
    ...
    <title>Prelude Admin</title>

    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?php print drupal_get_path('theme', 'opcaim') . '/bootstrap/css/bootstrap.min.css' ?>">
    <!-- Font Awesome -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Admin</b>Prelude</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2016 <a href="">Prelude Formation</a>.</strong> All rights reserved.
    </footer>
...
<!-- AdminLTE App -->
<script src="<?php  print drupal_get_path('theme', 'opcaim')."/dist/js/app.min.js" ?>"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php  print drupal_get_path('theme', 'opcaim')."/dist/js/demo.js" ?>"></script>
</body>
</html>