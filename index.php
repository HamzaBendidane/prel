...
Centre de formations auto</title>
...
<div id="wrap">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-9 portfolio-item">
                <a href="presentation.php">
                    <img class="img-responsive" src="images/prelude-2_03.gif" alt="">
                    <div class="text-reposnsive-2">Prelude formations

                        Une enseigne connue et reconnue
                        pour votre formation auto - moto et stage de conduite</div>
                </a>
            </div>
            <div class="col-xs-3 portfolio-item">
                <a href="acces.php">
                    <img class="img-responsive img-left" src="images/prelude-2_05.gif" alt="">
    ...
    <div class="row">
        ...
        <div class="col-xs-3 portfolio-item">
            <a href="contact.php">
                <img class="img-responsive" src="images/prelude-2_29.gif" alt="">
                <div class="text-reposnsive">CONTACT</div>
            </a>
        </div>
    </div>
        </div>
