...
define ("MONETICOPAIEMENT_URLOK", "http://cer-prelude.fr/monetico/confirmation_ok.php");
define ("MONETICOPAIEMENT_URLKO", "http://cer-prelude.fr/monetico/confirmation_ko.php");
